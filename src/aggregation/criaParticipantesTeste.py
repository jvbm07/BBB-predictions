...
path = "../../data/external/participantes/participantes2022.csv"
novo = criaTabelaParticipantes(path, 2022)
novo.to_csv("../../data/intermin/participantes/participantes2022.csv")